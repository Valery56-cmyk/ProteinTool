"""Модуль для построения изображения множественного выравнивания последовательностей"""

# code was taken from:
# https://www.biotite-python.org/latest/examples/gallery/sequence/homology/bionigma_alignment.html
